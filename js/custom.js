$(document).ready(function(){
	...
	$("section").on("mousemove",function(e){		
		...
		$(".obj1").css({"right":20-(posX/30) , "bottom":20-(posY/30) });
		$(".obj2").css({"right":130+(posX/20) , "bottom":-40+(posY/20) });
		$(".obj3").css({"right":60+(posX/20) , "top":180+(posY/20) });		
		...
		//다섯 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$(".p31").css({"right":280-(posX/30) , "bottom":30-(posY/30) });
		$(".p34").css({"right":110+(posX/20) , "bottom":-270+(posY/20) });
		$(".p35").css({"right":-70+(posX/20) , "bottom":-130+(posY/20) });	

		//여섯 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$("#con1 .obj4").css({"left":500+posX2,"bottom":-70+posY2});
    	$("#con1 .obj5").css({"right":-930+posX2,"bottom":-400+posY2});
    	$("#con1 .obj6").css({"left":250-posX2,"bottom":50-posY2});
